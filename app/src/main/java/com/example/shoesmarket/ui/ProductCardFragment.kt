...
class ProductCardFragment : BaseFragment(R.layout.fragment_product_card) {

    private val binding by viewBinding(FragmentProductCardBinding::bind)
    ...
    val sizeOfShoes = ArrayList<String>()
    ...
    private fun initTextFabric() {
        with(binding) {
            ...
            textFabric5.textBlack.text = "Nike"
        }
    }
